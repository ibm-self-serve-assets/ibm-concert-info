...
A Qualys vulnerability scan report for two Ubuntu VMs is available.
In this exercise:
- The Application SBOM and scan report and Application SBOM will be imported into Concert.
- Concert will analyze the data and generate patch actions for the detected vulnerabilities.
- After user approval, Concert workflows will automatically apply the required patches to the two VMs.
...
2. Click on **Define Application > From SBOM** menu to upload Application SBOM file.
...
2. Click and open the application **APP-TVS1**
<img src="images/img117.png" >

3. Explore the Application versions, topology and Collaborators tabs in the application inventory.
...
4. Return back to the **Versions** tab
...
2. You can see the **tvs1-staging**. 
...
2. Click on the **Workflows** tile.

<img src="images/img141.png" >

3. Click on **Create Workflow > Select from Library** menu
<img src="images/img142.png" >

4. Enter the following.
- Current Version : **v3.0.0**
- Filter : **Vulnerability**
- Usecase: **Discover Ubuntu Advisories** title

5. Click on **Import**
<img src="images/img143.png" >

The workflow is imported into the Concert Instance.
...
<img src="images/img146.png" >

3. Click on **Logs** Menu in left navigation
<img src="images/img147.png" >

You can see the execution of the workflow is completed in 51 minutes.

4. Click on the **Green arrow** to view the details.
<img src="images/img148.png" >
...
You can see the Vulnerability with empty records. 

2. Click on the **Upload vulnerability scan** button.
<img src="images/img151.png" >

3. Drag and Drop the above updated Qualys scan report for the Vulnerabilities.
...
1. Goto the **Action Center** page.

You can see the 2 actions listed with **Approval Pending** state.

2. Click on **Green down** arrow to see the details of the Actions.
<img src="images/img161.png" >

3. Click on **Review and Approve** link.
<img src="images/img162.png" >

4. Click on **Approve** button.
<img src="images/img163.png" >

5. Repeat the above steps for the second record as well.
...
```
[canary]
9.30.167.125 ansible_user=root ansible_ssh_common_args='-o StrictHostKeyChecking=no'
```
...
```
{
  "config": [
    {
      "auth": "ibmconcert/G-Linux_ssh_vm1",
      "host": ["9.30.167.125"]
    },
    {
      "auth": "ibmconcert/G-Linux_ssh_vm2",
      "host": ["9.46.72.158"]
    }
...
- Usecase : **Remediation_Master** tile
...
2. Enter **ibmconcert/G-Linux_ssh** in the linux_auth property
3. Click **Save** button
4. Click **Run** button to run the workflow
<img src="images/img194.png" >
